...
const Cart = () => {
    ...
    const handleRemoveAmount = async (id, amount) => {
        ...
        const response = await axios.post(`http://mikenco-aloalo.000webhostapp.com/api/cart/removeamount.php?id=${id}`, formData)
    ...
    const handleAddAmount = (id, amount) => {
        ...
        formData.append('amount', amount + 1);
        axios.post(`http://mikenco-aloalo.000webhostapp.com/api/cart/updateamount.php?id=${id}`, formData)
            .then(response => {
                getOrder();
            })
    ...
    const handleRemoveCart = (id) => {
        ...
        axios.post(`http://mikenco-aloalo.000webhostapp.com/api/cart/removecartitem.php?id=${id}`)
            .then(response => {
                getOrder();
            })
            .catch(error => console.error(error));
    ...
    const handlePayment = () => {
        ...
        axios.post('http://mikenco-aloalo.000webhostapp.com/api/cart/payment.php', data)
            .then(response => {
                if (response.data.success) {
