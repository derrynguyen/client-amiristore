...
const Cart = () => {
    ...
    const handleRemoveAmount = async (id, amount) => {
        ...
        const response = await axios.post(`https://14.225.205.66/Server/api/cart/removeamount.php?id=${id}`, formData)
    ...
    const handleAddAmount = (id, amount) => {
        ...
        formData.append('amount', amount + 1);
        axios.post(`https://14.225.205.66/Server/api/cart/updateamount.php?id=${id}`, formData)
            .then(response => {
                getOrder();
            })
    ...
    const handleRemoveCart = (id) => {
        ...
        axios.post(`https://14.225.205.66/Server/api/cart/removecartitem.php?id=${id}`)
            .then(response => {
                getOrder();
            })
            .catch(error => console.error(error));
    ...
    const handlePayment = () => {
        ...
        axios.post('https://14.225.205.66/Server/api/cart/payment.php', data)
            .then(response => {
                if (response.data.success) {
