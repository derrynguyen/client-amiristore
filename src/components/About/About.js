        ...
        <div className="vh-100" style={{ backgroundColor: '#eee' }}>
            <div className='container'>
                <div style={{ fontSize: '20px', height: 'fit-content', padding: '3vh' }}>
                    ...
                    <p style={{ fontSize: '16px', fontFamily: 'ThanhHai' }}>MSSV: <span style={{ fontSize: '19px', fontFamily: 'ThanhHai' }}>2001207201</span></p>
                    <p style={{ fontSize: '16px', fontFamily: 'ThanhHai' }}>Tên đồ án: <span style={{ fontSize: '19px', fontFamily: 'ThanhHai' }}>Đồ án web bán quần áo</span></p>
                </div>
