...
const Resigter = () => {
    ...
    const registerUser = async () => {
        ...
        try {
            const response = await axios.post('http://mikenco-aloalo.000webhostapp.com/api/users/register.php', { username, email, password, phone, addreas, sex, role, avatar, point });
