...
const Products = () => {
    ...
    const AddNewProducts = async () => {
        ...
        try {
            const response = await axios.post('https://14.225.205.66/Server/api/products/create.php', formData, {
                headers: {
    ...
    const EditProducts = (id) => {
        ...
        axios.post(`https://14.225.205.66/Server/api/products/edit.php?id=${id}`, formData, {
            headers: {
                'Content-Type': 'multipart/form-data',
            },
        })
